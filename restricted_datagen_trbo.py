...
def data_gen(ts_data:list) -> None:
    ...
    filepath = '/home/t778b526/Documents/bo_pid_trbo/trbo_dataset_comp4_trainset_05-19-25.csv'
    ...
    for i in range(len(ts_data)):
        ...
        print(ts_data[i])
        starttime = time.time()
        data_string = do_GP(ts_data[i][0], ts_data[i][1], ts_data[i][2], ts_data[i][3])
        endtime = time.time()
...
# get_ss(11.5008538570865,-1070.87409144139,5475.55658197794,116.067360445676)

# datastr = do_GP(31.5008538570865, -1070.87409144139, 5475.55658197794, 116.067360445676)
# print(datastr)

# doublet_test_exp(-68.76651,241.01189,-0.17544,5475.55658197794,116.067360445676,2248.41100901309,1173.80209164428,127.68336833755,126.448048464625,31.5008538570865,-1070.87409144139)
# doublet_test_exp(-69.06557,141.81787,-0.07182,5475.55658197794,116.067360445676,2248.41100901309,1173.80209164428,127.68336833755,126.448048464625,31.5008538570865,-1070.87409144139)
# doublet_test_exp(Kp,      Ki,       Kd,     Cai_dt,            Ti_dt,             Ca_dt,             Cb_dt,             Tr_dt,           Tk_dt,            Vdot_Vr_dt,          Qkdot_dt)
...
#         +"len_BO_1,no_expansions,expansion_frac,contraction_frac,maxw_kp,maxw_ki,maxw_kd,"\
#         +"zoom_frac,no_final_exp,minw_kp,minw_ki,minw_kd,Kc_init,Ki_init,Kd_init,min_iter_num,\n"
#     filepath = 'Documents/bo_pid/two_tanks_new_test/sequential_batch_BO_test_05-15-25_test_norm_Yvals.csv'
#     file_exists = os.path.isfile(filepath)
#     if not file_exists:      
#         f1 = open(filepath,'w')
#         f1.write(first_line)
